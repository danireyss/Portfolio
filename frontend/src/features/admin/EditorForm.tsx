...
export function EditorForm({ save, pending, onDone, children }: EditorFormProps) {
  ...
  return (
    <form onSubmit={onSubmit} className="flex flex-1 flex-col gap-5 px-4">
      {children}
      <div className="sticky bottom-0 mt-auto flex justify-end gap-2 border-t border-border bg-background py-4">
